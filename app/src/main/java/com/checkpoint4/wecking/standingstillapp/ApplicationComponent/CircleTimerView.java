...
public class CircleTimerView extends View
{
    ...
    private static final float DEFAULT_TIMER_NUMBER_SIZE = 40;
    ...
    private static final int DEFAULT_HIGHLIGHT_LINE_COLOR = 0xFFFA7777;
    private static final int DEFAULT_NUMBER_COLOR = 0x99FFFFFF;
    ...
    public static Double currentRadian;
...
//        canvas.drawColor(Color.RED);
        ...
        canvas.save();
        canvas.drawText("Set Record Time", cx, cy + getFontHeight(timerNumberPaint) / 2 + gapBetweenTimerNumberAndText + getFontHeight(timerTextPaint) / 2, timerTextPaint);
        canvas.restore();
        super.onDraw(canvas);
    }
    ...
    protected Parcelable onSaveInstanceState()
    {
        ...
        bundle.putDouble(STATUS_RADIAN, currentRadian);
        return bundle;
    }
    ...
    protected void onRestoreInstanceState(Parcelable state)
    {
        ...
        if (state instanceof Bundle)
        {
            ...
            currentRadian = bundle.getDouble(STATUS_RADIAN);
            currentTime = (int) (60 / (2 * Math.PI) * currentRadian * 60);
            return;
        }
